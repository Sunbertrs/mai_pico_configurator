...
def selection(image, current):
    ...
    draw.text((540,450), cmds_hid_text[1], font=sensor_titles_fontset[2], anchor="mm", fill="orange" if current == "joy" else "white")
    ...
    if current == "joy":
        ...
        _inst.root.bind("<KeyPress-Up>", lambda _: selection(image, "joy"))
