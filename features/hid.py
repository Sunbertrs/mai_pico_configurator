...
from preset_var import feat_hid_text
...
def main(instance):
    ...
    draw_title_and_prompting_keys(draw, feat_hid_text[0], feat_hid_text[5])
...
def selection(current):
    ...
    for i, j in enumerate(option, start=1):
        draw_selecting_options(draw, i, feat_hid_text[i], (current == j))
